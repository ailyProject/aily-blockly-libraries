...
| `max31865_read` | Statement | TEMP_VAR(field_variable), RESISTANCE_VAR(field_variable), STATUS_VAR(field_variable) | `max31865_read($temperature, $resistance, $status)` | `maxTemp.MAX31865_GetTemperatureAndStatus(` |
