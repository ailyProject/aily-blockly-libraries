...
|------------|------------|--------------------------|------------|----------------|
| `mt6701_init` | Statement | OBJECT(field_variable) | `mt6701_init(variables_get($encoder))` | `` |
| `mt6701_init_advanced` | Statement | OBJECT(field_variable), ADDRESS(dropdown), INTERVAL(input_value) | `mt6701_init_advanced(variables_get($encoder), 0x06, math_number(1000))` | `` |
...
arduino_setup()
    ...
    mt6701_init_advanced(variables_get($encoder), 0x06, math_number(1000))
