...
| `adxl345_read_xyz` | Statement | VAR_X(field_variable), VAR_Y(field_variable), VAR_Z(field_variable) | `adxl345_read_xyz($accel_x, $accel_y, $accel_z)` | `sensors_event_t event;\n` |
