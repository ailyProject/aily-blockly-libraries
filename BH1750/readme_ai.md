...
| `bh1750_read_light_level` | Value | VAR(field_variable) | `bh1750_read_light_level($lightMeter)` | (dynamic code) |
...
1. **Variable Creation**: `bh1750_init_with_wire("varName", ...)` creates variable `$varName`; reference with `$varName`
