...
Arduino.forBlock["taskscheduler_create"] = function (block, generator) {
  var schedulerName = generator.getVariableName(
    block.getFieldValue("SCHEDULER"),
    "Scheduler",
  );
...
Arduino.forBlock["status_request_create"] = function (block, generator) {
  var statusRequestName = generator.getVariableName(
    block.getFieldValue("STATUS_REQUEST"),
    "StatusRequest",
  );
